...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private enum Constants {
        static let loginNavigationControllerIdentifier = "LoginPage"
        static let PlaygroundNavigationControllerIdentifier = "FeedNavigationController"
    ...
    private func login() {
        ...
        self.window?.rootViewController = storyboard.instantiateViewController(withIdentifier: Constants.PlaygroundNavigationControllerIdentifier)
    }
